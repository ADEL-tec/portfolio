      ...
      <div className="flex w-full flex-col lg:flex-row items-center gap-20 my-20">
        ...
        <div className="flex-1">
          <p className="mb-10 max-w-2xl font-Ovo">
            I am an experienced Mobile Application Developer specializing in
            Flutter, with experience in building, testing, and maintaining
            cross-platform mobile applications using Dart, focusing on
